...
const __dirname = path.resolve(); // without this, tweet cache will be in the dist directory on windows which gets reset on every build
...
export class ClientBase extends EventEmitter {
    ...
    lastCheckedHomeTimelineId: number | null = null;
    homeTimelineCacheFilePath = __dirname + "/tweetcache/latest_checked_home_timeline_id.txt";
    ...
    constructor({ runtime }: { runtime: IAgentRuntime }) {
        ...
        try {
            ...
            console.error(
                "Error loading latest checked tweet IDs from files:",
                error
            );
        }
